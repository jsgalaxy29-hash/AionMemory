...
public class AionDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var tagsConverter = new ValueConverter<ICollection<string>, string>(
            tags => JsonSerializer.Serialize(tags ?? Array.Empty<string>(), (JsonSerializerOptions?)null),
        ...
        var tagsComparer = new ValueComparer<ICollection<string>>(
            ...
            value => (ICollection<string>)(value ?? Array.Empty<string>()).ToList());
        ...
        modelBuilder.Entity<F_File>(builder =>
        {
            ...
            builder.Property(f => f.OcrText).HasMaxLength(16000);
        ...
        {
            builder.Property<Guid>("WorkspaceId").IsRequired();
            builder.Property(t => t.Name).IsRequired().HasMaxLength(128);
