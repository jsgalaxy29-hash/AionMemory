...
public sealed class DemoModuleSeeder
{
    ...
    private readonly IAionDataEngine _dataEngine;
    private readonly ILogger<DemoModuleSeeder> _logger;

    public DemoModuleSeeder(IMetadataService metadata, IAionDataEngine dataEngine, ILogger<DemoModuleSeeder> logger)
    {
        _metadata = metadata;
    ...
    private async Task EnsureSampleRecordAsync(Guid entityId, CancellationToken cancellationToken)
    {
        ...
        var payload = new Dictionary<string, object?>
        {
            ...
            ["notes"] = "Rencontr̩e lors du salon VivaTech."
        };
