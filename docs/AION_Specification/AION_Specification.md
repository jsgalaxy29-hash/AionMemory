...
> Specification cible du produit.
> Ce document decrit l'architecture visee et les capacites attendues ; certaines sections peuvent depasser l'etat actuellement implemente dans le depot.
> Le code source et les guides operationnels de `docs/` restent la reference pour le comportement reel.
