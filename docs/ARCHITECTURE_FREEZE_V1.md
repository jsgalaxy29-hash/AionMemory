...
### Contrats Domain
Fichiers de reference (tous dans `Aion.Domain`) :
...
## Regles CI
- Si un fichier sous `Aion.Domain/` change et modifie un contrat public gele, `docs/ARCHITECTURE_FREEZE_V1.md` doit etre mis a jour dans le meme changement.
- Cette regle n'est effective en CI que lorsqu'un workflow de verification existe reellement dans le depot.
