...
> Document historique.
> Cet audit date du 2026-03-13 et plusieurs references de chemins utilisent encore l'ancien prefixe logique `src/`.
> Pour l'arborescence actuelle du depot, lire ces references sans le prefixe `src/` (`Aion.AppHost/...`, `Aion.Domain/...`, etc.).
