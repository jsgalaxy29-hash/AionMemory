...
> Ce backlog decrit des travaux cibles et des hypotheses de roadmap ; il ne represente pas l'etat reel d'implementation a lui seul.
> Pour l'etat courant du depot, croiser avec le code, les tests et les guides operationnels de `docs/`.
