...
public sealed class DynamicFormFieldRegistryTests : TestContext
{
    ...
    public void Dynamic_form_renders_expected_components_for_text_number_and_select()
    {
        ...
        table.Fields.Add(MakeField("Name", FieldDataType.Text));
        table.Fields.Add(MakeField("Count", FieldDataType.Number));
        table.Fields.Add(MakeField("Category", FieldDataType.Enum, enumValues: "A,B"));
    ...
    public void Dynamic_form_source_does_not_switch_on_component_kind()
    {
        ...
        var formPath = Path.Combine(repositoryRoot, "Aion.AppHost", "Components", "DynamicForm.razor");
